...
lineas_kmdt=0
digitos_kmdt="0123456789"
cantidadDigitos_kmdt=0
cadena_kmdt=input("Cadena: ")
while cadena_kmdt!="*":
    for caracter in cadena_kmdt:
        if caracter in digitos_kmdt:
            cantidadDigitos+=1
    if cadena_kmdt=="/":
        lineas_kmdt+=1
        ...
        cantidadDigitos=0
    cadena_kmdt=input("Cadena: ")
print("Se leyeron ",lineas_kmdt," líneas completas")